...
if($_POST){
    ...
    $farmer_id = $_SESSION['username'];
    
    $q = mysqli_query($connection, "update crop_details set crop_type='{$crop_type}', crop_name='{$crop_name}',unit_price = '{$unit_price}'
    , unit_name ='{$unit_name}', stock='{$stock}' where farmer_id='{$editid}' and crop_id = '{$crop_id}'") or 
    die(mysqli_error($connection));
    if($q){
        echo "<script>alert('Record Updated');window.location='cropdetails.php';</script>";
    }
}
?>
        ...
        <div class="container mt-4 mb-4 p-3 d-flex justify-content-center">
            <div class="card p-4">
                ...
                <div class=" image d-flex flex-column justify-content-center align-items-center"> <button class="btn btn-secondary"> <img src="https://media.nationalgeographic.org/assets/photos/120/983/091a0e2f-b93d-481b-9a60-db520c87ec33.jpg" height="100" width="100" /></button>
                    ...
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">&nbsp;Crop Type:<input type="text" value="" name="crop_type"/></div><br/>
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">&nbsp;&nbsp;&nbsp;&nbsp;Crop Name:<input type="text" value=""name="crop_name"/></span></div> <br/>
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">&nbsp;&nbsp;&nbsp;Unit Price:<input type="number" value="" name="unit_price"/> </div><br/>
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">&nbsp;&nbsp;Unit Name:<input type="text" value="" name="unit_name"/> </div><br/>
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">&nbsp;&nbsp;Stock:<input type="text" value="" name="stock"/> </div><br/>
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Crop Id:<input type="text" value="" name="crop_id"/></div><br/>
                    <input type="submit" value="Edit" class="btn1 btn-dark">
                    <div class=" d-flex mt-2"> <button class="btn1 btn-dark"> <a href="cropdetails.php">Crop Details</a></button> </div>
