        ...
        <div class="container mt-4 mb-4 p-3 d-flex justify-content-center">
            <div class="card p-4">
                ...
                <div class=" image d-flex flex-column justify-content-center align-items-center"> <button class="btn btn-secondary"> <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ79J9CUATagpDZSpsMypcBCkkPh6OO_CK-Fw&usqp=CAU" height="100" width="100" /></button>
                    ...
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">&nbsp;Full Name:<input type="text" value="<?php echo $editrow['fullname'] ?>" name="fullname"/></div> <br/>
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">&nbsp;&nbsp;&nbsp;&nbsp;Mobile No:<input type="number" value="<?php echo $editrow['mobileno'] ?>" name="mobileno"/></span> </div><br/>
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Address:<input type="textarea" value="<?php echo $editrow['address'] ?>" name="address"/> </div><br/>
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;State:<input type="text" value="<?php echo $editrow['state'] ?>" name="state"/> </div><br/>
                    <div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;City:<input type="text" value="<?php echo $editrow['city'] ?>" name="city"/></div><br/>
