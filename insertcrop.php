...
if($_POST){
    ...
    $q = mysqli_query($connection, "insert into crop_details(crop_type,crop_name,unit_price,unit_name,stock,crop_id,farmer_id)
            values('{$crop_type}','{$crop_name}','{$unit_price}','{$unit_name}', '{$stock}', '{$crop_id}','{$farmer_id}')") or 
    die(mysqli_error($connection));
    if($q){
